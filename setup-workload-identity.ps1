...
Write-Host "Workload Identity binding created successfully!"
Write-Host "Remember to update the service account annotation in k8s/service-account.yaml with your actual project ID"